// 2D/3D value + simplex-style gradient noise with fractal (FBM) layering.
// Original implementation (standard public-domain algorithms).
...
export class Noise {
  ...
  fbm3D(x, y, z, octaves = 3, lacunarity = 2.0, gain = 0.5) {
    let amp = 1, freq = 1, sum = 0, norm = 0;
    for (let o = 0; o < octaves; o++) {
  ...
  // Ridged noise for mountains, in [0, 1]
